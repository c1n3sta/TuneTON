import { Home, Library, ShoppingBag, Trophy } from "lucide-react";
...
export default function BottomNavigation({ activeTab, onNavigate }: BottomNavigationProps) {
  const tabs = [
    ...
    { name: "NFT", icon: ShoppingBag, emoji: "💎" },
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-1 h-full">
                  ...
                  {/* Tab label */}
                  <motion.span
                    className={`text-xs font-semibold transition-all duration-300 leading-none ${isActive
                        ? "text-white"
                        : "text-[#8b949e]"
                      }`}
