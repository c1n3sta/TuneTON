...
// Assets provided by Figma MCP local server
...
const imgGroup1 = 'http://localhost:3845/assets/e0a235cec9e6e10aa19e1551872c0532e987b04f.svg';
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24, padding: '24px 0' }}>
        <div style={{ width: 64, height: 64 }}>
          <img src={imgGroup1} alt="studio icon" style={{ width: '100%', height: '100%' }} />
        </div>
        ...
        <div style={{ color: '#8b949e', fontSize: 14, textAlign: 'center', lineHeight: '1.4', maxWidth: 360 }}>
          Unleash your creativity with AI-powered stem editing
          <br />
          and advanced remixing tools.
        </div>
        {/* Dots */}
