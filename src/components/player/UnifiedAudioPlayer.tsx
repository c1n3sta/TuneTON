import { FileText, Heart, Share, ThumbsDown, Pause, Play, SkipBack, SkipForward, Volume2, VolumeX } from 'lucide-react';
...
const UnifiedAudioPlayer: React.FC<UnifiedAudioPlayerProps> = ({ track, onTrackEnd, onPrevious, onNext }) => {
  const {
    isPlaying,
    currentTime,
    duration,
  ...
  const isEQActive = !eqBypass && eqBands.some((band: number) => band !== 0);
