-- Fix mutable search_path issue for the embedding-based recommend_tracks function
-- This function provides track recommendations based on audio embeddings and user preferences
