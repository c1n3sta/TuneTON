...
export default function MusicApp() {
  ...
  const [showOnboarding, setShowOnboarding] = useState(false); // Changed to false initially for testing
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (tg) {
        ...
        // Check onboarding status for dev mode
        const hasCompletedOnboarding = localStorage.getItem('tunton_onboarding_completed');
        if (!hasCompletedOnboarding) {
          setShowOnboarding(true);
        }
  ...
  const handleTelegramConnect = async () => {
    try {
      ...
      if (tg) {
        // Request user data if not already available
  ...
  const handleOnboardingComplete = () => {
    ...
    // Reset to home page after onboarding
    setActiveTab("Home");
    setCurrentPage("home");
  };
        ...
        {currentPage === "nft-detail" && (
          <NFTDetail 
            ...
            onBuy={(nftId) => {
              ...
              // In real app, this would handle purchase
            }}
            onBid={(nftId, amount) => {
              console.log(`Bidding ${amount} on NFT ${nftId}`);
              // In real app, this would handle bidding
            }}
            onLike={(nftId) => {
              console.log(`Liking NFT ${nftId}`);
              // In real app, this would handle liking
            }}
          />
        )}
        ...
        {currentPage === "create-nft" && (
          <CreateNFT 
            ...
            onCreateNFT={(nftData) => {
              ...
              // In real app, this would handle NFT creation
        ...
        {currentPage === "nft-auction" && (
          <NFTAuction 
            ...
            onPlaceBid={(auctionId, amount) => {
              ...
              // In real app, this would handle bid placement
            }}
